var shareImageButton = document.querySelector(
  "#share-image-button"
);
...
var sharedMomentsArea = document.querySelector(
  "#shared-moments"
);
...
var locationLoader = document.querySelector(
  "#location-loader"
);
var manualLocation = document.querySelector(
  "#manual-location"
);
...
captureButton.addEventListener("click", function(event) {
  ...
  context.drawImage(
    ...
    videoPlayer.videoHeight /
      (videoPlayer.videoWidth / canvas.width)
  );
...
function closeCreatePostModal() {
  ...
  locationBtn.style.display = "inline";
  locationLoader.style.display = "none";
  createPostArea.style.display = "inline";
...
var url = "https://pgram-836b3.firebaseio.com/posts.json";
